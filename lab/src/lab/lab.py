...
################################################################################
## Form generated from reading UI file 'labbpolsX.ui'
##
...
"#Sub1, #menu, #q1_header, #q2_header,#new_2,#new_3,#container_3,#new_4,#name_widget,#widget_4{\n"
"border-radius: 15px;\n"
...
"{\n"
"border-radius: 15px;\n"
"background-color: qlineargradient(x1: 0, y1: 0, x2: 1, y2: 1, stop: 0 #29323c, "
                        "stop: 0.3 #485563, stop: 1 #2e3f50);\n"
"color: #FFFFFF;\n"
"border: 1px solid #555555;\n"
"padding: 20px;}")
...
"")
        ...
        self.verticalLayout_24 = QVBoxLayout(self.stud_profile)
        self.verticalLayout_24.setObjectName(u"verticalLayout_24")
        self.widget_9 = QWidget(self.stud_profile)
        ...
        self.img.setMaximumSize(QSize(200, 200))

        self.verticalLayout_25.addWidget(self.img)

        self.name_3 = QLabel(self.widget_4)
        self.name_3.setObjectName(u"name_3")
        self.name_3.setFont(font)
        self.name_3.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.verticalLayout_25.addWidget(self.name_3)


        self.horizontalLayout_10.addWidget(self.widget_4, 0, Qt.AlignTop)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.b10.setText(QCoreApplication.translate("MainWindow", u"LAB EXAM", None))
        ...
        self.name_3.setText(QCoreApplication.translate("MainWindow", u"VYSHNAV M", None))
